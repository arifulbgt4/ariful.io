...
Security headers avoid an untested Content Security Policy. Add CSP only after production reporting identifies every required script, image, connection, and style source.
...
6. Run the full verification chain before deployment.
