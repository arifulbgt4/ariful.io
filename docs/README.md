# Ariful.io Documentation

This directory contains the operating context for humans and AI agents.

| Document | Purpose |
| --- | --- |
| [`PROJECT_CONTEXT.md`](PROJECT_CONTEXT.md) | Product mission, audience, verified profile facts, constraints, and success signals |
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | Runtime, routes, content model, integrations, and system boundaries |
| [`DEVELOPMENT_GUIDE.md`](DEVELOPMENT_GUIDE.md) | Local setup, change workflow, testing, and code conventions |
...
| [`ROADMAP.md`](ROADMAP.md) | Prioritized follow-up work that requires evidence, credentials, or new scope |

`AGENTS.md` at the repository root is the mandatory AI-agent entrypoint.
