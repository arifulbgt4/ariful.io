...
6. **Products before stacks.** Buyer outcomes, lifecycle ownership, maturity,
   ...
   delivery decision.
7. **Equal core evidence.** The six core products use the same card scale,
...
Positioning hero → delivery ownership → six equal core products → highlighted
...
Offer → fit criteria → six-product proof → engagement options → free
