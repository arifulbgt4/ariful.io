...
| `npm run portfolio:check` | Validate the six-core/two-lab portfolio contract, evidence fields, unique slugs, and retired flagship language |
...
5. Keep all six core products at equal presentation priority. Do not add a
