...
| `/work` | Static | Six equal core products plus a highlighted EEE Simulator research foundation and separate Lab experiments |
...
and must not change the six-core hierarchy or imply a higher maturity stage.
