    ...
    <main id="main-content" className="page-shell">
      <div className="site-container max-w-3xl">
        ...
        <div className="prose-portfolio mt-10">
          <p>This website collects the information you choose to submit through the project enquiry form: your name, email, company or product, project type, budget range, timeline, and message.</p>
          ...
          <p>When configured, the form sends the enquiry through the site&apos;s email provider. Email and hosting providers may process the technical data needed to deliver the request. Enquiries may be retained in email records for follow-up, legal, security, and business administration.</p>
          <h2>Your choice</h2>
