    ...
    <main id="main-content" className="page-shell">
      <div className="site-container max-w-3xl">
        ...
        <div className="prose-portfolio mt-10">
          ...
          <p>Ariful.io uses Vercel Web Analytics for aggregated page-view, visitor, and limited conversion-interaction trends and Vercel Speed Insights for anonymous real-user performance and Core Web Vitals measurements. These tools are used to understand which public routes and hiring paths are useful and where the site experience needs improvement; they are not advertising trackers.</p>
          ...
          <p>Names, email addresses, project-brief content, Calendly selections, meeting details, and other personal or confidential information are never included in analytics URLs, query parameters, or event properties. The site records only fixed, non-personal event names when someone loads the consultation scheduler, opens the external Calendly fallback, or receives a successful project-brief response. Important service-to-hire links also send an allowlisted public source label and the selected consultation or project-brief intent. These events measure interaction and a successful form API response only; they do not report inbox receipt, a Calendly booking, consultation attendance, lead identity, enquiry content, or paid engagement. Review the <a href="https://vercel.com/docs/analytics/privacy-policy" target="_blank" rel="noreferrer">Vercel Web Analytics privacy documentation</a> and <a href="https://vercel.com/docs/speed-insights/privacy-policy" target="_blank" rel="noreferrer">Vercel Speed Insights privacy documentation</a> for provider details.</p>
